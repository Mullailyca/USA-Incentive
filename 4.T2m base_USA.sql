...
-- Modify date: <>                          
-- Description: <USA_KB_T2M>                            
-- =============================================                            
ALTER  procedure MIS_1717_USA_03_T2M_BASE    
as     
begin    
    
--Sp_rename 'Mis_1717_USA_T2M_Res_mly','Mis_1717_USA_T2M_Res_mly_202507'    
...
Set @Sql='    
IF OBJECT_ID(''Mis_1717_USA_T2M_'+@month1+''') is not null    
Drop table Mis_1717_USA_T2M_'+@month1+'    
...
into Mis_1717_USA_T2M_'+@month1+'    
from [MIS_1717_BS_wrkard_master_dontdrop]    
where topupseq=''1''    
and convert(varchar(07),topupdate,120)='''+@month3+''''    
Exec (@sql)    
    
Set @Sql='Delete from Mis_1717_USA_T2M_'+@month1+'    
...
Set @Sql='Alter Table Mis_1717_USA_T2M_'+@month1+'    
Add    
...
from Mis_1717_USA_T2M_'+@month1+' a join ##POS1 b                
on a.iccid=b.iccid'    
Exec (@sql)    
...
from Mis_1717_USA_T2M_'+@month1+' a join ##res b          
on LEFT(a.iccid,11) between b.iccid_fr and b.iccid_to'    
Exec (@sql)      
    
Set @Sql='update a                
set a.Wholesalerid=b.OffMgrID           
from Mis_1717_USA_T2M_'+@month1+' a join MVNOREPORT_USA_LM.dbo.vw_DSMOffMgrResellerMapping b                
...
Set @Sql='Update Mis_1717_USA_T2M_'+@month1+' set Gateway=b.Paymentchannel    
from Mis_1717_USA_T2M_'+@month1+' a,##ITG b    
where a.iccid=b.iccid'    
Exec (@sql)    
    
Set @Sql='Update Mis_1717_USA_T2M_'+@month1+' set Gateway_Offmgr=     
...
Set @Sql='update Mis_1717_USA_T2M_'+@month1+' set OffMgrID=Gateway_Offmgr,Wholesalerid=Gateway_Offmgr    
...
from [MIS_1717_BS_wrkard_master_dontdrop]    
where topupseq=''3''    
and convert(varchar(07),topupdate,120) between '''+@month3+''' and '''+@month+''''    
Exec (@sql)     
...
Set @Sql='update Mis_1717_USA_T2M_'+@month1+' set Topup_status=''Yes''    
from Mis_1717_USA_T2M_'+@month1+' a,##deva b    
where a.iccid=b.iccid'    
Exec (@sql)     
    
Set @Sql='    
IF OBJECT_ID(''Mis_1717_USA_T2M_'+@month1+'_Res'') is not null    
Drop table Mis_1717_USA_T2M_'+@month1+'_Res    
Select Wholesalerid ,Count(iccid) FCA,Count(Topup_status) TS    
into Mis_1717_USA_T2M_'+@month1+'_Res    
from Mis_1717_USA_T2M_'+@month1+'    
where resellerid not like ''%-NI-%''    
group by Wholesalerid'    
Exec (@sql)     
    
Set @Sql='Alter table Mis_1717_USA_T2M_'+@month1+'_Res Add T2M float,Type Varchar(20)'    
Exec (@sql)     
    
Set @Sql='Update Mis_1717_USA_T2M_'+@month1+'_Res set T2M=round(cast(TS as float)/Cast(FCA as float),4)*100'    
Exec (@sql)      
    
Set @Sql='Update Mis_1717_USA_T2M_'+@month1+'_Res set Type=''Platinum''    
where T2M>=50'    
Exec (@sql)     
    
--Set @Sql='Update Mis_1717_USA_T2M_'+@month1+'_Res set Type=''Gold''    
--where T2M between 40 and 49.99'    
--Exec (@sql)     
    
--Set @Sql='Update Mis_1717_USA_T2M_'+@month1+'_Res set Type=''Silver''    
--where T2M between 30 and 39.99'    
--Exec (@sql)     
...
Set @Sql='Alter table Mis_1717_USA_T2M_'+@month1+' Add T2M_FCA float,T2M_TP float,T2M_PER float,T2M_Type Varchar(20)'    
Exec (@sql)     
    
Set @Sql='update Mis_1717_USA_T2M_'+@month1+' set T2M_FCA=b.FCA,T2M_TP=b.Ts,T2M_PER=b.T2M,T2M_Type=b.Type    
from Mis_1717_USA_T2M_'+@month1+' a,Mis_1717_USA_T2M_'+@month1+'_Res b    
where a.Wholesalerid=b.Wholesalerid'    
Exec (@sql)     
    
--select Distinct Offmgrid,T2M_FCA,T2M_TP,T2M_PER,T2M_Type from Mis_1717_USA_T2M_'+@month1+'    
--order by T2M_PER desc    
Set @Sql='    
IF OBJECT_ID(''Mis_1717_USA_T2M_Res_mly'') is not null    
Drop table Mis_1717_USA_T2M_Res_mly    
Select * into Mis_1717_USA_T2M_Res_mly from Mis_1717_USA_T2M_'+@month1+'_Res    
    
Select * from Mis_1717_USA_T2M_'+@month1+'_Res'    
Exec (@sql)     
    
Set @Sql='    
IF OBJECT_ID(''Mis_1717_USA_T2M_'+@month1+'_Final'') is not null    
Drop table Mis_1717_USA_T2M_'+@month1+'_Final    
Select distinct Resellerid,T2M_FCA,T2M_TP,T2M_PER,T2M_type  into Mis_1717_USA_T2M_'+@month1+'_Final from Mis_1717_USA_T2M_'+@month1+''    
Exec (@sql)     
    
Set @Sql='    
IF OBJECT_ID(''Mis_1717_USA_T2M_Res_mly_'+@month1+''') is not null    
Drop table Mis_1717_USA_T2M_Res_mly_'+@month1+'    
    
Select * into Mis_1717_USA_T2M_Res_mly_'+@month1+' from Mis_1717_USA_T2M_Res_mly'    
Exec (@sql)    
